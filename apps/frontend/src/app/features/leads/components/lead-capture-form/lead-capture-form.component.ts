...
import { CardHeadingComponent } from '../../../../shared/components/ui/card/card-heading.component';
import { CardSubheadingComponent } from '../../../../shared/components/ui/card/card-subheading.component';
...
@Component({
  ...
  imports: [CardComponent, LabelComponent, InputComponent, ButtonComponent, CardHeadingComponent, CardSubheadingComponent, CardHeaderComponent, CardHeaderComponent],
  template: `
		<app-card shadow="xl">
			<div class="space-y-8">
				<app-card-header>
