...
import { ContactProjection, RegisterContactCommandHandler, GetAllContactsQueryHandler, RecordMessageSentToContactCommandHandler } from '@effectiv-crm/application';
...
@Module({
  ...
  providers: [
    ...
    RecordMessageSentToContactCommandHandler,
    // Projection
    {
